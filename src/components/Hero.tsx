    ...
    >
      ...
      <div className="max-w-5xl mx-auto text-center relative z-10">
        ...
        >
          ...
          <br />
          Ik hou van uitdagingen en complexe problemen oplossen.
        </motion.p>
        ...
        >
          <button
            ...
            className="px-8 py-4 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-lg hover:shadow-lg hover:scale-105 transition-all duration-200 font-medium"
          >
            Ontdek mijn verhaal
          </button>
          <button
            ...
            className="px-8 py-4 bg-white dark:bg-slate-800 text-slate-700 dark:text-slate-200 rounded-lg hover:shadow-lg hover:scale-105 transition-all duration-200 font-medium border border-slate-200 dark:border-slate-700"
          >
            Neem contact op
          </button>
        </motion.div>
