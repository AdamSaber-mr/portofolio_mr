...
export function Projects() {
  ...
  const projects = [
    ...
    },
    {
      ...
      description: 'Collaborative filtering systeem dat producten of films aanbeveelt gebaseerd op gebruikersvoorkeuren en gedrag.',
      tags: ['Python', 'Machine Learning', 'Collaborative Filtering', 'Pandas'],
      highlights: [
        'Content-based filtering algoritme',
        'User similarity berekeningen',
    ...
    },
    {
      ...
      description: 'Data analyse project dat weerpatronen analyseert en visualiseert met behulp van historische weerdata en statistische methoden.',
      tags: ['Python', 'Pandas', 'Matplotlib', 'API Integration'],
      highlights: [
        'Historische data van 5+ jaar',
  ...
  return (
    <section id="projects" className="py-20 px-4 bg-white dark:bg-slate-900">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-2 gap-6">
          {projects.map((project, index) => (
            <motion.div
              ...
              className="bg-gradient-to-br from-slate-50 to-white dark:from-slate-800 dark:to-slate-700 p-6 rounded-2xl shadow-md hover:shadow-xl transition-all duration-300 border border-slate-100 dark:border-slate-700 group"
            >
              {/* Header */}
              <div className="flex items-start justify-between mb-4">
                <div className="flex items-center gap-3">
                  <div className={`p-3 bg-gradient-to-br ${project.gradient} rounded-lg group-hover:scale-110 transition-transform`}>
              ...
              <div className="mb-4 space-y-2">
                {project.highlights.map((highlight, i) => (
                  <div key={i} className="flex items-start gap-2">
                    <div className={`w-1.5 h-1.5 rounded-full bg-gradient-to-r ${project.gradient} mt-2`} />
        ...
        >
          <div className="inline-block bg-gradient-to-r from-blue-50 to-purple-50 dark:from-slate-800 dark:to-slate-700 p-6 rounded-2xl border border-blue-100 dark:border-slate-700">
